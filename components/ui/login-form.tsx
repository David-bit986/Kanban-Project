                    ...
                    <form className="space-y-4">
                        <FieldGroup className="gap-4">
                            ...
                            <div className="flex flex-col gap-3 pt-2">
                                ...
                                <Button variant="outline" type="button" className="w-full bg-white/5 hover:bg-white/10 text-white border-white/10 font-medium rounded-full h-11 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] gap-2">
